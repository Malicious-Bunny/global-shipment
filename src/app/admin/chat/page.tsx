  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-primary">Live Chat</h1>
      ...
      {loading ? (
        ...
        <div className="rounded-xl border border-neutral-200 bg-surface p-12 text-center">
        ...
        <div className="space-y-2">
          {sessions.map((s) => (
            <Link
              ...
              className="flex items-center gap-4 rounded-xl border border-neutral-200 bg-surface px-5 py-4 shadow-xs hover:border-secondary/40 hover:shadow-md transition-all cursor-pointer"
            >
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-secondary/10">
                <ChatCircle size={20} weight="duotone" className="text-secondary" />
              </div>
